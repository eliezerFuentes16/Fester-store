...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 05-10-2021 a las 19:36:37
...
INSERT INTO `pedidos` (`id`, `idPedido`, `NOMBRE`, `TELEFONO`, `DIRECCION`, `EMAIL`, `FECHAHORA`, `OBSERVACIONES`, `FORMAPAGO`, `CAMBIO`, `COLONIA`, `SUCURSAL`, `STATUS`, `PRODUCTOS`, `TOTAL`, `ENTREGADO`, `idCliente`, `Factura`, `NombreRazonSocial`, `rfc`) VALUES
(1, 1379071, 'Eliezer Fuentes', '04166876793', 'Delfin Mendoza', 'eliezermario008@gmail.com', '2021-09-20 14:37:53', 'Tengo Hmabre', 'Pasar a Recoger', '', '', '', 'Cancelado', '[[78,{\"id\":\"2346410\",\"nombre\":\"Festegral 20Kg\",\"descripcion\":\"Producto en polvo finamente molido, de color gris claro, contiene sales de ácidos grasos que favorecen la reducción de la permeabilidad en concretos y morteros, sin disminuir la resistencia a la compresión.\",\"precio\":656.2,\"cantidad\":\"1\",\"total\":656.2,\"sucursal\":\"\"}]]', 656.2, 1, 1, 0, NULL, ''),
